...
// Inner class for iterator
  ...
  // why not add to linkedList?? would be pushing passed the MAX_INTEGER limit
  // saves us space / ram
  // int - 32 bits
  // long - 64 bits
  public class ListIterator {
    ...
    public boolean hasPrevious() { return mPrev != null;}
    ...
    public E previous() {
      Node<E> temp = mHead;
      mNext = mPrev; // making NEXT point to PREV
      mCursor--;
    ...
    public int nextIndex() { return mCursor + 1; }

    public int previousIndex(){ return mCursor - 1; }

    public void add(E element) {
      LinkedList.this.add(element); // Reference to outer Class ----> this ---- add(element)
      //this.add(element) recursively keeps being called again
    }
